...
const labels: Readonly<Record<string, string>> = Object.freeze({
  ...
  CODEGRAPH_CALL_PATH_UNAVAILABLE: "CodeGraph 调用路径暂不可判定",
  CODEGRAPH_TRACE_BOUNDED: "CodeGraph 调用链搜索达到安全边界",
  ...
  REPAIR: "知识修复",
  CODEGRAPH: "CodeGraph",
  CURRENT_STATE: "当前代码事实",
  USER_DECISION: "用户决策",
  FUTURE_REQUIREMENT: "未来需求",
  COMPLETE: "定位完整",
  LEGACY: "历史知识（未定位）",
  ...
  BRANCH_LINEAGE: "提交谱系",
  ALL_BRANCHES: "所有分支",
  UPDATE_VERSION: "更新场景版本",
  MERGE_VERSION: "合并场景版本",
  KEEP_SEPARATE: "保持场景分离",
  CALL_PATH: "调用链查询",
  IMPACT: "影响面查询",
  ACTIVE: "可复用",
  SUSPECT: "疑似过期",
  PROJECTED: "已建立投影",
  LOCATOR_COMPLETE: "项目、版本与场景定位完整",
  LEGACY_LOCATOR_UNAVAILABLE: "旧知识尚无定位信息",
  LOCATOR_REVISION_UNRESOLVED: "当前代码结论缺少可信提交版本",
  LOCATOR_INVALID: "知识定位字段不符合约束",
