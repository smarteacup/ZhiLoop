  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "apps/sidecar/src/{application,config,control-plane,diagnostic-log,hook-command,mcp-command,metadata,p1-runtime,p2-automatic-compilation,p2-preview-coordinator,p2-production,p2-freshness-runtime,p2-evolution-jobs,p2-evolution-runtime,p4-active-runtime,p4-console,p4-retrieval,transport}.ts",
      ],
