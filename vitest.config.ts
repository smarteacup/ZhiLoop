  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "apps/sidecar/src/{application,config,control-plane,diagnostic-log,hook-command,mcp-command,metadata,p1-runtime,p4-active-runtime,p4-console,p4-retrieval,transport}.ts",
      ],
